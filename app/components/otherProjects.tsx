  ...
  return (
    <>
      <div className="flex justify-center items-center mt-16">
        <div className="bg-light-green rounded-full w-20 h-20 flex justify-center items-center">
          <svg
            fill="#FFFF"
            width="1.5rem"
            height="1.5rem"
      ...
      <div className="content m-4">
        ...
        <p className="font-archivo text-faded">{description}</p>
      </div>
      <div className="techStack flex flex-wrap gap-2 m-4">
        {techStack.map((tech) => (
          <div key={tech} className="bg-faded p-2 rounded-xl">
            {tech}
          </div>
        ))}
      </div>
      <div className="liveBtn flex m-4 gap-2">
        {/* GitHub */}
