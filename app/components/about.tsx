          ...
          <div className="aboutLeft flex flex-col max-w-2xl">
            <div className="abouttext font-archivo mb-16">
              <p>
                ...
                in Gauteng, South Africa. My experience comes from building
                personal projects alongside my{" "}
                <span className="font-extrabold">
                  BSc in Information Technology (Software Engineering)
                </span>
                . I specialize in frontend technologies including HTML & CSS,
                JavaScript, React, Tailwind CSS, and Git/GitHub, with a strong
                focus on creating clean, responsive, and user-friendly
                interfaces. I believe that ideas can be brought to life through
                code, and my goal is to translate concepts into functional,
